  ...
  return (
    <section>
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <br />
            {/* Header Section */}
            <div className="max-w-3xl mx-auto text-white text-center pb-12 md:pb-16">
            ...
            <div className="grid gap-20">
                ...
                <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
                    {/* Image */}
                    <div className="max-w-xl md:max-w-none md:w-full max-auto md:col-span-5 lg:col-span-6 mb-8 md:mb-0 md:order-1"
                         data-aos="fade-up"
                    >
                        <img
                            className='max-w-full max-auto md:max-w-none h-auto'
                            src={images[0].src}
                            width="540"
                            height="405"
                            alt={images[0].title}
