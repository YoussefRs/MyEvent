...
export default function singup() {
    ...
    const handleVerifyEmail = async (event) => {
        ...
        const response = await fetch(
            `${process.env.PUBLIC_API}/user/signup`,
            {
                method: "POST",
                headers: {
    ...
    <div className='m-2'>
        ...
        <div className="max-w-3xl mx-auto mt-10">
            ...
            <div className="flex items-center justify-center">
                ...
                <div className={`w-full h-24 lg:h-fit ${
                    step === 1 ? `font-medium` : ``
                }`}
                >
                    <div
                ...
                >
                    <div
                        className={`h-full border-2 border-l-0 px-5 py-2 ${
                            step >= 2 
                            ? `text-gray-400 bg-[color:var(--darker-secondary-color)] border-r-white border-[color:var(--darker-secondary-color)]`
                ...
                <div
                    className={`h-full border-2 border-l-0 rounded-r-lg px-5 py-2 ${
                        step >= 3 
                        ? `text-gray-400 bg-[color:var(--darker-secondary-color)] border-[color:var(--darker-secondary-color)]`
                        : `border-[color:var(--darker-secondary-color)] border-dashed`
                    }`}
                ></div>
                    <div>03</div>
